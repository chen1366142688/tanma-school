...
export default {
  ...
  methods: {
    ...
    toDetail(item) {
      ...
      this.$router.push({ name: "queryClassTestData" });
    },
    querySearch(){
      this.pageNum = 1;
      this.pageNo = 1
    ...
    exportSchoolTestData(){
      ...
      let url =
        ...
        '/v1/testdataexport/exportTestHistoryData?grade='+(vm.grade==99?'':vm.grade)+'&schoolYear='+vm.schoolYear+'&schoolId=1&type=1' +
        '&token=' +
    ...
    search(){
      this.$axios
        .get(
          `/v1/testdata/queryActivityStatisticsHisList?grade=${this.grade==99?'':this.grade}&schoolYear=${this.schoolYear}&schoolId=${this.schoolId}&type=2`
        )
        .then(res => {
          if (res.data.code == 10000) {
            ...
            this.$axios
              .get(
                `/v1/testdata/queryActivityStatisticsHisList?grade=${this.grade==99?'':this.grade}&schoolYear=${this.schoolYear}&schoolId=${this.schoolId}&type=1`
              )
              .then(res => {
                if (res.data.code == 10000) {
  ...
  mounted() {
    ...
    console.log(sessionStorage.getItem("historyData_grade"))
    vm.grade = sessionStorage.getItem("historyData_grade") == null || sessionStorage.getItem("historyData_grade") == 'null' ? 99 : Number(sessionStorage.getItem("historyData_grade"));
    this.search()
  }
}
</script>