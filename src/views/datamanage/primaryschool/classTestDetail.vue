          ...
          <Row>
            ...
            <Col v-show="notsign" span="2">
              ...
              <Button
                ...
                :disabled="!(heightList && heightList.length>0)"
        ...
        <Card style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(weightList && weightList.length>0 )"
        ...
        <Card style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(vitalCapacityValueList && vitalCapacityValueList.length>0 )"
        ...
        <Card style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(runFiftyValueList && runFiftyValueList.length>0 )"
        ...
        <Card v-if="schoolType != '2'" style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(standingJumpValueList && standingJumpValueList.length>0 )"
        ...
        <Card style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(sitAndReachValueList && sitAndReachValueList.length>0 )"
        ...
        <Card v-if="gender == '2' && schoolType != '2'" style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(runEightHundredValueList && runEightHundredValueList.length>0 )"
        ...
        <Card v-if="gender == '1' && schoolType != '2'" style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(runThousandValueList && runThousandValueList.length>0 )"
        ...
        <Card v-if="schoolType == '2'" style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(oneMinuteRopeSkippingValueList && oneMinuteRopeSkippingValueList.length>0 )"
        ...
        <Card v-if="schoolType == '2' && gradeId>2" style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(oneMinuteSitUpValueList && oneMinuteSitUpValueList.length>0 )"
        ...
        <Card v-if="schoolType == '2' && gradeId>4" style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(runFiftyEightValueList && runFiftyEightValueList.length>0 )"
        ...
        <Card v-if="gender == '1' && schoolType != '2'" style="margin-bottom:20px;">
          <Row>
            ...
            <Col v-show="notsign" span="2">
              <Button
                style="margin-left:10px;"
                :disabled="!(pullUpsValueList && pullUpsValueList.length>0 )"
            ...
            <Row style="margin-bottom:20px;">
              ...
              <Col v-show="notsign" span="12">
                ...
                <div>
                  ...
                  <Button
                    style="margin-left:10px;"
                    :disabled="!(historyVision && historyVision.length>0 )"
