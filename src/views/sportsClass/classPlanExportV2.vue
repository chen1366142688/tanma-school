  ...
  <div>
    ...
    <div style="margin-top:15px;">
      <Card style="height: 60px;">
        ...
        >
          <Button type="success" >导入排课信息</Button>
        </Upload>
    ...
    methods: {
      ...
      exportData(taskId) {
        ...
        let url =this.$axios.defaults.baseURL +
                "/v1/primarysportsclass/exportClassPlanError?taskId=" +
                taskId +
                "&token=" +
      ...
      getTaskList(schoolId,taskType) {
        ...
        this.$axios.post("/v1/primarysportsclass/getTaskList", data).then(res => {
          vm.loading = false;
      ...
      countTaskListNum(schoolId,taskType) {
        ...
        this.$axios.post("/v1/primarysportsclass/countTaskListNum", data).then(res => {
          if (res.data.code == 10000) {
