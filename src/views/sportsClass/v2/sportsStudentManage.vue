...
<template>
  <div>
    ...
    <div>
      <h2 style="margin-top:15px">导入体育课成员自动分组</h2>
      <Card>
        <div class="top-search">
            <div class="left-input">
                <div style="margin:5px 20px;">
                    <span>导入数量：</span><span>{{exportAllNum}}</span>
                </div>
                <div style="margin:5px 20px;">
                    <span style="margin-left:30px">成功数量：</span><span>{{exportSuccessNum}}</span>
                </div>
                <div style="margin:5px 20px;">
                    <span style="margin-left:30px">错误数量：</span><span style="color:red">{{exportFailNum}}</span>
                </div>
            </div>
            <div class="right-btns">
                ...
                >
                    <Button type="success">批量导入班级和成员</Button><i style="color:red">*体育课名称不能重复</i>
                </Upload>
                <Button type="success" :disabled="failTf" @click="exportPeErrorData">导出错误数据</Button>
                <Button type="success"  @click="exportAllStudentPre">导出模版格式</Button>
                <Button @click="pageToList" type="success" >返回</Button>
            </div>
        </div>
      </Card>
      <h2 style="margin-top:20px">导入教学班排课信息</h2>
      <Card style="height:45px;margin-top:2px">
        <div >
        ...
        <Button style="margin-left:150px;" type="success"  @click="exportAllClassPlanPre">导出模版格式</Button>
    ...
    <div style="margin-top:20px;">
      ...
      <Card style="width:45%;float:left;">
        ...
        <div style="margin-top: 15px;">
          ...
          <span style="margin-left:40px;">分组情况:</span>
      ...
      <Card style="width:45%; float:left;">
        <div>
          ...
          <span style="margin-left:40px">成员分组：</span>
          ...
          <Button type="success" style="margin-left:80px;" @click="bathdelete">批量移出</Button>
          <!-- <Button type="success" style="margin-left:80px;" @click="baseSubmit">保存</Button> -->
        </div>
        <p ><h1 style="margin-top:28px;">{{peClassName}}--学生：</h1></p>
...
export default {
  ...
  mounted() {
    ...
    if(sessionStorage.getItem("sportsClass-sportsStudentManage-sportsClassId")){
            this.peClassId=Number(sessionStorage.getItem("sportsClass-sportsStudentManage-sportsClassId"));
          }
    vm.isCollege = true;
    vm.getStartYearList();
    ...
    vm.updateUrl =
      ...
      "/v1/sports/class/file/upload/sportsClassExport?schoolId=" +
      sessionStorage.getItem("schoolId") +
      "&token=" +
      sessionStorage.getItem("token");
      vm.updateUrlPlan=this.$axios.defaults.baseURL +
